const CACHE='gym-v5-2';
const ASSETS=['./','./index.html','./styles.css','./core.js','./exercises.js','./app.js','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-512.png','./icon-maskable-512.png'];
